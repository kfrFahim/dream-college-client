...
const CollegeDetails = () => {
     ...
     return (
          ...
          <div className='w-1/2'>
          <figure>
                <img className='h-[350px]' src={colleges.college_image} alt="Shoes" />
              </figure>
          </div>
              ...
              <div className="card-body">
               ...
               <div>Events : {colleges.details?.events.map((event , i)=> <p key={i}> {event} </p> ) }  </div>
               <div>Sports : {colleges.details?.sports_facilities.map((event , i)=> <p key={i}> {event} </p> ) }  </div>
